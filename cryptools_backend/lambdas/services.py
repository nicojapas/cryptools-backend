...
class CoinGeckoService:
    ...
    def get_coin_by_id(coin_id: str) -> Dict[str, Any]:
        ...
        formatted_coin = {
            ...
            "marketCapChangePercentage24H": str(market_data.get("market_cap_change_percentage_24h", 0)),
            ...
            "wrapped": "wrapped" in coin_data.get("name", "").lower() or "w" in coin_data.get("symbol", "").lower(),
    ...
    def get_trending_news(limit: int = 20) -> List[Dict[str, Any]]:
        ...
        for result in data.get('results', []):
            news_item = {
                ...
                "url": result.get('url'),
                "currencies": [curr.get('code') for curr in result.get('currencies', [])],
